...
function EgovNoticeList(props) {
    ...
    const retrieveList = useCallback((searchCondition) => {
        ...
        const retrieveListURL = '/riders'+EgovNet.getQueryString(searchCondition);;
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                resp._embedded.riders.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <Link
                            to={{pathname: "/riderManagement/RiderDetail"}}
                            state={{
                                riderId: item._links.self.href.split('/').pop(),
            ...
            <div className="c_wrap">
                ...
                <div className="location">
                    <ul>
                        ...
                        <li><Link to={URL.INFORM}>Rider Management</Link></li>
                        <li>Rider</li>
                    </ul>
                </div>
                {/* <!--// Location --> */}
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="top_tit">
                            <h1 className="tit_1">Rider Management</h1>
                        </div>

                        <h2 className="tit_2">Rider</h2>
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                <li className="third_2 R">
                                    ...
                                    <li>
                                        <Link to="/riderManagement/RiderEdit" state={{bbsId: bbsId}} className="btn btn_blue_h46 pd35">등록</Link>
                                    </li>
                            </ul>
                        </div>
                        {/* <!--// 검색조건 --> */}

...
function EgovNoticeEdit(props) {
    ...
    const updateBoard = () => {
        ...
        const entity = {
            riderId: boardDetail.riderId,
            orderId: boardDetail.orderId
        };

        axios.post('/riders', entity)
        .then(response => {
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="board_view2">
                            <dl>
                                <dt>
                                    <label htmlFor="nttSj">Rider ID</label>
                                </dt>
                                <dd>
                                    <input className="f_input2 w_full" id="riderId" name="riderId" type="text"
                                        onChange={e => setBoardDetail({ ...boardDetail, riderId: e.target.value })}
                                        maxLength="60" />
                                </dd>
                            </dl>
                            <dl>
